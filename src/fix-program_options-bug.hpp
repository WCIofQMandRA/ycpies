//fix-program_options-bug.hpp: 修复boost::program_options在UTF-8的一个码位
//内部换行的bug
...
void print_options_decription(std::ostream &out,const boost::program_options::options_description &discription,
	unsigned line_length=boost::program_options::options_description::m_default_line_length,
	unsigned min_decription_length=boost::program_options::options_description::m_default_line_length/2);
