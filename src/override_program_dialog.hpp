//override_program_dialog.hpp: 导出程序时确认覆盖已有文件的对话框
//包含类OverrideProgramDialog
...
//输入索引对话框
class OverrideProgramDialog: public wxDialog
{
public:
	OverrideProgramDialog(wxWindow *parent,const wxString &filename);
	bool remember()const;
private:
	wxCheckBox *m_check;
};
