...
{
extern std::filesystem::path appdata;//储存配置文件的目录
extern std::filesystem::path exedir;//可执行文件所在的目录
extern boost::program_options::variables_map args;//使用boost::program_options处理过的命令行参数
extern std::string argv0;//argv[0]
extern std::map<std::string,std::string> license;//本软件和各组件使用的许可证
}
