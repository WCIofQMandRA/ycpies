//new_dialog.hpp: 新建控制器程序集时弹出的对话框
//包含类NewDialog
...
{
public:
	NewDialog(wxWindow *parent,const wxString &caption);
	unsigned get_first()const;
	unsigned get_size()const;
private:
	wxTextCtrl *m_edit_first,*m_edit_size;
	wxStaticText *m_label_first,*m_label_size;
};
